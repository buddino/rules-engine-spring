package it.unifi.dinfo.updater;
...
@Component
public class UpdateExeedingsNaturalLight implements Updater{
    Long exceedings;
    ...
    public void update() {
        double light = ScheduledClass.getLatestFor("gaia-prato/gw1/weather/light").getReading();
        ...
        String exceedings = sparks.readPropertyAndSetDefault("gaia-prato/gw1/weather/light", "exceedings", 0);
